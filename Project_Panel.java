...
public class Project_Panel extends JPanel
{
   ...
   // allows for arraylist transfer
   public ArrayList<ArrayList<GameObject>> access()
   {
      return data;
   }
   // Used during testing to find exact positions
   ...
   // Contructor that reads in the data stores it 
   public Project_Panel()
   {
      ...
      // paints the data by taking in the draw method 
         ...
         // key listener to read in key inputs
   ...
   // listener that constantly reads in inputs and checks for collisions 
   public class TimeListener implements ActionListener
   {
      public void actionPerformed(ActionEvent e)
      {
         ...
         // checks for OnGround, Ceiling, and win methods from panel
             if(jump==false)
             {
